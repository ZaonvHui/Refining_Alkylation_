function three_reactor_C3_opt
%Equal split-decision variable V1 V2 V3 T
%87 variables
%FCj-x[1-54];Dv-x[55-57];ri-x[58-63];ki-x[64-65];Ci-x[66-83];T-x[84];Vi-x[85-87]
...
for i=1:6
    ...
    Aeq(12+i,(6*(5-1)+i))=1;%Fi,0a1=Fi,0a*s1;Fi,0a2=Fi,0a*s2;Fi,0a3=Fi,0a*s3
    beq(12+i)=F0a(i)*s1;
    Aeq(18+i,(6*(6-1)+i))=1;
    beq(18+i)=F0a(i)*s2;
    Aeq(24+i,(6*(7-1)+i))=1;
...
lb(84)=233;lb(85:87)=0;
for i=1:87
    ub(i)=1e5;
end
ub(84)=273;ub(85:87)=100;
%obtain x0
x0_fsolve=ones(1,84);%?
